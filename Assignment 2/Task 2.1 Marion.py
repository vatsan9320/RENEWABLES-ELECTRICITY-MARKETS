...
# def CVaR_approximation_ksi_positif(in_sample):
#     ## Create a model
#     model = ConcreteModel()
...
#     # VaR (ksi) 1 per minute per sample
#     model.ksi = Var(model.init_time, model.init_profiles, within=NonNegativeReals, initialize=0)
